...
class SX1262: public SX126x {
  ...
  private:
    ...
    int16_t beginFSK_i(uint32_t freq_Hz, uint32_t br_bps, uint32_t freqDev_Hz, uint16_t rxBw_kHz_x10,
      int8_t power, uint8_t currentLimit_mA_div2_5, uint16_t preambleLength,
      uint8_t dataShaping_x10, uint8_t tcxoVoltage_x10);

    int16_t setFrequency_i(uint32_t freq_Hz, bool calibrate = true);
};
